...
interface RepoContextProps {
  repos: Repo[];
  filteredRepos: Repo[];
  setFilters: (filters: { language?: string; owner?: string; nameSearch?: string }) => void;
}
...
export const RepoProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [filters, setFilters] = useState<{ language?: string; owner?: string; nameSearch?: string }>({});
